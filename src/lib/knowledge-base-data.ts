// This file contains the data that you should upload to your Firestore "knowledge_base" collection.
// In a real application, this data would live in the database, not in the codebase.
...
export const documents: Document[] = [
    {
        ...
        keywords: ['tax', 'regime', 'new', 'old', 'compare', 'deductions', 'slabs', '80c', '80d', 'hra']
    },
    {
        id: 'mutual-funds-101',
    ...
    },
    {
        ...
        keywords: ['insurance', 'term', 'health', 'ulip', 'endowment', 'cover', 'sum', 'assured', 'employer']
    },
    {
