  ...
  return (
    ...
    >
      <g stroke="none" strokeWidth="1" fillRule="evenodd">
        ...
        ></path>
        <path
          d="M53,25.9 C53,25.9 50.5,45.2 56.3,49.9 C62.1,54.6 64.6,25.9 64.6,25.9 L53,25.9 Z"
          fill="#BCA8E8"
        ></path>
        <path
          d="M56.3,25.9 C56.3,25.9 53.8,45.2 59.6,49.9 C65.4,54.6 67.9,25.9 67.9,25.9 L56.3,25.9 Z"
          fill="#1B8B77"
        ></path>
      </g>
    </svg>
