...
export function FireResultCard({ id, result, explanation }: FireResultCardProps) {
    return (
                ...
                <div className="p-4 rounded-xl bg-background/50 border border-border/20 shadow-inner">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div className="flex items-start gap-3 p-3 rounded-lg bg-background/50">
                        ...
                        <div>
                            ...
                            <p className="font-semibold text-red-400">🔴 ₹{result.targetCorpus.toLocaleString('en-IN')}</p>
                        </div>
                    </div>
                     <div className="flex items-start gap-3 p-3 rounded-lg bg-background/50">
                 ...
                 {!result.canRetire && (
                    <div className="text-center p-3 bg-background/50 rounded-lg">
                        <p className="text-sm text-muted-foreground">Est. years to reach your goal with current investment:</p>
